                ...
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="button-items text-right">
                            ...
                            <button type="button" class="btn btn-outline-purple">CSV Update</button>
                    ...
                    <div class="card">
                        ...
                        <div class="col-md-12">
                            ...
                            <li class="nav-item waves-effect waves-light">
                                <a class="nav-link" data-bs-toggle="tab" href="ui-tabs-accordions.html#home-1" role="tab" aria-selected="false">Action Required (0)</a>
                            </li>
                            <li class="nav-item waves-effect waves-light">
                                <a class="nav-link active" data-bs-toggle="tab" href="ui-tabs-accordions.html#profile-1" role="tab" aria-selected="true">Action Requested (0)</a>
                            </li>
                            <li class="nav-item waves-effect waves-light">
                                <a class="nav-link" data-bs-toggle="tab" href="ui-tabs-accordions.html#settings-1" role="tab" aria-selected="false">Delivered (0)</a>
                            </li>
                            <li class="nav-item waves-effect waves-light">
                                <a class="nav-link" data-bs-toggle="tab" href="ui-tabs-accordions.html#canceled-1" role="tab" aria-selected="false">RTO (0)</a>
                            </li>
                        </ul>
                        </div>
                                        ...
                                        <table class="table" id="datatable_2">
                                            <thead class="thead-light">
                                                <tr>
                                                    ...
                                                    <th>CHANNEL</th>
                                                    <th data-type="date" data-format="YYYY/DD/MM">NDR DATE</th>
                                                    <th>ORDER</th>
                                                    <th>PRODUCT</th>
                                                    <th>PAYMENT</th>
                                                    <th>CUSTOMER</th>
