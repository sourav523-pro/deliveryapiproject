...
<div class="left-sidebar">
    ...
    <div class="border-end">
        <ul class="nav nav-tabs menu-tab nav-justified" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="index.html#Main" role="tab" aria-selected="true">M<span>ain</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="index.html#Extra" role="tab" aria-selected="false">E<span>xtra</span></a>
            </li>
        </ul>
    </div>
    <!-- Tab panes -->
        ...
        <div class="menu-body navbar-vertical">
            <div class="collapse navbar-collapse tab-content" id="sidebarCollapse">
                ...
                <ul class="navbar-nav tab-pane active" id="Main" role="tabpanel">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.html#sidebarCrypto" data-bs-toggle="collapse" role="button"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.html#sidebarEmail" data-bs-toggle="collapse" role="button"
            ...
            <li class="dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-lg pt-0">
                    ...
                    <div class="notification-menu" data-simplebar>
                        <!-- item-->
                        <a href="index.html#" class="dropdown-item py-3">
